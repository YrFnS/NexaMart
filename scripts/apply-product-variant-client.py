...
# ─── Shared storefront product/variant type ───────────────────────────────────
replace_once(
...
# ─── Cart lines prefer immutable SKU identity ─────────────────────────────────
replace_once(
...
# Checkout submits the SKU ID as well as the immutable option snapshot.
replace_once(
...
# ─── Replace the local-only seller product editor with persistent APIs ─────────
write(
    "src/components/seller/product-management.tsx",
    ''''use client';
...
print("Product variant storefront and seller changes applied successfully.")
