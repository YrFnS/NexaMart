...
export const APP_TAGLINE = 'Multi-vendor ordering and fulfilment';
...
export const APP_DOMAIN = new URL(APP_URL).host;
const appEmailDomain = APP_DOMAIN.split(':')[0] || 'nexamart.com';
export const APP_SUPPORT_EMAIL = `support@${appEmailDomain}`;
export const APP_NOREPLY_EMAIL = `noreply@${appEmailDomain}`;
export const APP_SUPPORT_PHONE =
  process.env.NEXT_PUBLIC_SUPPORT_PHONE || '+964 000 000 0000';
export const APP_ADDRESS =
  process.env.NEXT_PUBLIC_APP_ADDRESS || 'Baghdad, Iraq';
...
export const AI_CONFIG = {
  ...
  referer: APP_URL,
  title: `${APP_NAME} AI commerce tools`,
...
export const DEFAULT_SELLER_PHONE =
  process.env.NEXT_PUBLIC_DEFAULT_SELLER_PHONE || '+9640000000000';
