...
export const APP_DESCRIPTION = 'Discover thousands of products from verified sellers with AI-powered shopping';
...
export const SOCIAL_SHARE = {
  ...
  whatsappDirect: (phone: string, text: string) => `https://wa.me/${phone.replace(/[^0-9]/g, '')}?text=${encodeURIComponent(text)}`,
...
export const DEFAULT_TIMEZONE = process.env.NEXT_PUBLIC_DEFAULT_TIMEZONE || 'Asia/Riyadh';
