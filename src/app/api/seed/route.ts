...
export async function POST() {
  try {
    ...
    await db.category.createMany({
      data: [
        { name: 'Electronics', nameAr: 'إلكترونيات', slug: 'electronics', icon: 'smartphone', image: 'https://placehold.co/400x300/6366f1/ffffff?text=Electronics', productCount: 156 },
        { name: 'Fashion', nameAr: 'أزياء', slug: 'fashion', icon: 'shirt', image: 'https://placehold.co/400x300/ec4899/ffffff?text=Fashion', productCount: 243 },
        { name: 'Home & Garden', nameAr: 'المنزل والحديقة', slug: 'home-garden', icon: 'home', image: 'https://placehold.co/400x300/10b981/ffffff?text=Home+Garden', productCount: 89 },
        { name: 'Beauty & Health', nameAr: 'الجمال والصحة', slug: 'beauty', icon: 'sparkles', image: 'https://placehold.co/400x300/f59e0b/ffffff?text=Beauty', productCount: 167 },
        { name: 'Sports & Outdoors', nameAr: 'رياضة', slug: 'sports', icon: 'dumbbell', image: 'https://placehold.co/400x300/3b82f6/ffffff?text=Sports', productCount: 78 },
        { name: 'Toys & Games', nameAr: 'ألعاب', slug: 'toys', icon: 'gamepad-2', image: 'https://placehold.co/400x300/8b5cf6/ffffff?text=Toys', productCount: 56 },
        { name: 'Automotive', nameAr: 'سيارات', slug: 'automotive', icon: 'car', image: 'https://placehold.co/400x300/ef4444/ffffff?text=Automotive', productCount: 34 },
        { name: 'Books & Media', nameAr: 'كتب ووسائط', slug: 'books', icon: 'book-open', image: 'https://placehold.co/400x300/14b8a6/ffffff?text=Books', productCount: 112 },
        { name: 'Food & Groceries', nameAr: 'طعام وبقالة', slug: 'food', icon: 'shopping-basket', image: 'https://placehold.co/400x300/f97316/ffffff?text=Food', productCount: 95 },
        { name: 'Jewelry & Watches', nameAr: 'مجوهرات وساعات', slug: 'jewelry', icon: 'watch', image: 'https://placehold.co/400x300/eab308/ffffff?text=Jewelry', productCount: 67 },
      ],
    });
    ...
    await db.store.createMany({
      data: [
        { name: 'TechStore Pro', nameAr: 'متجر التقنية', slug: 'techstore-pro', description: 'Your one-stop shop for the latest tech gadgets and electronics', descriptionAr: 'وجهتك الأولى لأحدث الأجهزة والإلكترونيات', logo: 'https://placehold.co/200x200/10b981/ffffff?text=Store', banner: 'https://placehold.co/1200x300/059669/ffffff?text=Banner', ownerId: seller.id, isVerified: true, rating: 4.8, reviewCount: 342, productCount: 45, tier: 'pro', commission: 8 },
        { name: 'Fashion Hub', nameAr: 'مركز الأزياء', slug: 'fashion-hub', description: 'Trendy fashion for everyone', descriptionAr: 'أزياء عصرية للجميع', logo: 'https://placehold.co/200x200/10b981/ffffff?text=Store', banner: 'https://placehold.co/1200x300/059669/ffffff?text=Banner', ownerId: seller2.id, isVerified: true, rating: 4.6, reviewCount: 189, productCount: 78, tier: 'pro', commission: 10 },
        { name: 'Home Essentials', nameAr: 'أساسيات المنزل', slug: 'home-essentials', description: 'Everything for your home', descriptionAr: 'كل ما تحتاجه لمنزلك', logo: 'https://placehold.co/200x200/10b981/ffffff?text=Store', banner: 'https://placehold.co/1200x300/059669/ffffff?text=Banner', ownerId: seller3.id, isVerified: true, rating: 4.5, reviewCount: 156, productCount: 34, tier: 'free', commission: 12 },
        { name: 'Beauty World', nameAr: 'عالم الجمال', slug: 'beauty-world', description: 'Premium beauty products', descriptionAr: 'منتجات تجميل فاخرة', logo: 'https://placehold.co/200x200/10b981/ffffff?text=Store', banner: 'https://placehold.co/1200x300/059669/ffffff?text=Banner', ownerId: seller4.id, isVerified: true, rating: 4.7, reviewCount: 267, productCount: 56, tier: 'pro', commission: 9 },
        { name: 'Sports Zone', nameAr: 'المنطقة الرياضية', slug: 'sports-zone', description: 'Gear up for any sport', descriptionAr: 'استعد لأي رياضة', logo: 'https://placehold.co/200x200/10b981/ffffff?text=Store', banner: 'https://placehold.co/1200x300/059669/ffffff?text=Banner', ownerId: seller5.id, isVerified: false, rating: 4.3, reviewCount: 98, productCount: 23, tier: 'free', commission: 10 },
      ],
    });
    ...
    await db.product.createMany({
      data: [
        { id: 'WHP-001', name: 'Wireless Bluetooth Headphones Pro', nameAr: 'سماعات بلوتوث لاسلكية برو', description: 'Premium noise-cancelling wireless headphones with 40-hour battery life.', descriptionAr: 'سماعات لاسلكية متميزة بعزل الضوضاء مع بطارية تدوم 40 ساعة', price: 89.99, originalPrice: 129.99, images: '["https://placehold.co/400x400/10b981/ffffff?text=Headphones"]', categoryId: categories[0].id, storeId: stores[0].id, stock: 150, rating: 4.7, reviewCount: 234, soldCount: 1520, isFeatured: true, isSale: true, hasFreeShipping: true, variations: '{"color":["Black","White","Navy"]}', tieredPricing: '[{"minQty":5,"price":82.99},{"minQty":10,"price":75.99}]', tags: '["wireless","bluetooth","headphones"]', sku: 'WHP-001' },
        { id: 'SWU-002', name: 'Smart Watch Ultra', nameAr: 'ساعة ذكية ألترا', description: 'Advanced smartwatch with health monitoring, GPS, and 7-day battery life.', descriptionAr: 'ساعة ذكية متقدمة مع مراقبة الصحة وGPS وبطارية 7 أيام', price: 249.99, originalPrice: 349.99, images: '["https://placehold.co/400x400/10b981/ffffff?text=Smart+Watch"]', categoryId: categories[0].id, storeId: stores[0].id, stock: 75, rating: 4.8, reviewCount: 567, soldCount: 3200, isFeatured: true, isNew: true, isSale: true, hasFreeShipping: true, variations: '{"color":["Titanium","Black","Orange"],"size":["42mm","46mm"]}', tags: '["smartwatch","fitness","gps"]', sku: 'SWU-002' },
        { id: 'PLJ-003', name: 'Premium Leather Jacket', nameAr: 'سترة جلد فاخرة', description: 'Handcrafted genuine leather jacket with premium stitching.', descriptionAr: 'سترة جلد طبيعي مصنوعة يدوياً بخياطة فاخرة', price: 199.99, originalPrice: 299.99, images: '["https://placehold.co/400x400/10b981/ffffff?text=Leather+Jacket"]', categoryId: categories[1].id, storeId: stores[1].id, stock: 45, rating: 4.5, reviewCount: 89, soldCount: 430, isFeatured: true, isSale: true, hasFreeShipping: true, variations: '{"color":["Black","Brown","Tan"],"size":["S","M","L","XL"]}', tags: '["leather","jacket","premium"]', sku: 'PLJ-003' },
        { id: 'UHC-004', name: '4K Ultra HD Camera', nameAr: 'كاميرا 4K ألترا HD', description: 'Professional-grade 4K camera with 30x optical zoom and WiFi.', descriptionAr: 'كاميرا احترافية بدقة 4K مع تقريب بصري 30x وWiFi', price: 599.99, originalPrice: 799.99, images: '["https://placehold.co/400x400/10b981/ffffff?text=4K+Camera"]', categoryId: categories[0].id, storeId: stores[0].id, stock: 30, rating: 4.9, reviewCount: 156, soldCount: 890, isFeatured: true, isNew: true, isSale: true, hasFreeShipping: true, variations: '{"color":["Black"]}', tieredPricing: '[{"minQty":3,"price":549.99}]', tags: '["camera","4k","professional"]', sku: 'UHC-004' },
        { id: 'OSS-005', name: 'Organic Skincare Set', nameAr: 'مجموعة العناية بالبشرة العضوية', description: 'Complete organic skincare routine with cleanser, toner, and serum.', descriptionAr: 'روتين عناية بالبشرة عضوي كامل', price: 79.99, originalPrice: 119.99, images: '["https://placehold.co/400x400/10b981/ffffff?text=Skincare"]', categoryId: categories[3].id, storeId: stores[3].id, stock: 200, rating: 4.6, reviewCount: 312, soldCount: 2100, isFeatured: true, isSale: true, variations: '{"type":["Normal","Oily","Dry"]}', tags: '["organic","skincare","beauty"]', sku: 'OSS-005' },
        { id: 'GMK-006', name: 'Gaming Mechanical Keyboard', nameAr: 'لوحة مفاتيح ميكانيكية للألعاب', description: 'RGB mechanical gaming keyboard with Cherry MX switches.', descriptionAr: 'لوحة مفاتيح ميكانيكية RGB بمفاتيح Cherry MX', price: 149.99, originalPrice: 189.99, images: '["https://placehold.co/400x400/10b981/ffffff?text=Keyboard"]', categoryId: categories[0].id, storeId: stores[0].id, stock: 120, rating: 4.7, reviewCount: 445, soldCount: 1890, isSale: true, hasFreeShipping: true, variations: '{"switch":["Red","Blue","Brown"],"layout":["US","Arabic"]}', tags: '["gaming","keyboard","mechanical"]', sku: 'GMK-006' },
        { id: 'RSP-007', name: 'Running Shoes Pro Max', nameAr: 'حذاء جري برو ماكس', description: 'Lightweight running shoes with advanced cushioning.', descriptionAr: 'حذاء جري خفيف الوزن مع وسائد متقدمة', price: 129.99, originalPrice: 169.99, images: '["https://placehold.co/400x400/10b981/ffffff?text=Shoes"]', categoryId: categories[4].id, storeId: stores[4].id, stock: 80, rating: 4.4, reviewCount: 178, soldCount: 670, isNew: true, isSale: true, hasFreeShipping: true, variations: '{"color":["Black/White","Blue/Orange"],"size":["7","8","9","10","11"]}', tags: '["running","shoes","sports"]', sku: 'RSP-007' },
        { id: 'SHH-008', name: 'Smart Home Hub', nameAr: 'مركز المنزل الذكي', description: 'Central smart home controller compatible with all platforms.', descriptionAr: 'جهاز تحكم مركزي للمنزل الذكي متوافق مع جميع المنصات', price: 179.99, originalPrice: 229.99, images: '["https://placehold.co/400x400/10b981/ffffff?text=Smart+Hub"]', categoryId: categories[2].id, storeId: stores[2].id, stock: 55, rating: 4.3, reviewCount: 92, soldCount: 340, isNew: true, hasFreeShipping: true, variations: '{"color":["White","Black"]}', tags: '["smart-home","iot"]', sku: 'SHH-008' },
        { id: 'DPN-009', name: 'Diamond Pendant Necklace', nameAr: 'قلادة بدلاية ألماس', description: 'Elegant diamond pendant in 18K white gold.', descriptionAr: 'قلادة أنيقة بدلاية ألماس من الذهب الأبيض عيار 18', price: 899.99, originalPrice: 1199.99, images: '["https://placehold.co/400x400/10b981/ffffff?text=Jewelry"]', categoryId: categories[9].id, storeId: stores[1].id, stock: 15, rating: 4.9, reviewCount: 67, soldCount: 89, isFeatured: true, isSale: true, hasFreeShipping: true, variations: '{"metal":["White Gold","Yellow Gold"],"size":["16in","18in"]}', tags: '["diamond","necklace"]', sku: 'DPN-009' },
        { id: 'EMD-010', name: 'Espresso Machine Deluxe', nameAr: 'آلة إسبريسو ديلوكس', description: 'Professional espresso machine with built-in grinder.', descriptionAr: 'آلة إسبريسو احترافية مع مطحنة مدمجة', price: 449.99, originalPrice: 599.99, images: '["https://placehold.co/400x400/10b981/ffffff?text=Tea"]', categoryId: categories[2].id, storeId: stores[2].id, stock: 25, rating: 4.6, reviewCount: 134, soldCount: 560, isSale: true, hasFreeShipping: true, variations: '{"color":["Silver","Black"]}', tags: '["espresso","coffee"]', sku: 'EMD-010' },
        { id: 'KET-011', name: 'Kids Educational Tablet', nameAr: 'لوح تعليمي للأطفال', description: 'Fun educational tablet for kids with parental controls.', descriptionAr: 'لوح تعليمي ممتع للأطفال مع رقابة أبوية', price: 149.99, originalPrice: 199.99, images: '["https://placehold.co/400x400/10b981/ffffff?text=Earbuds"]', categoryId: categories[5].id, storeId: stores[0].id, stock: 60, rating: 4.2, reviewCount: 89, soldCount: 340, isNew: true, isSale: true, variations: '{"color":["Blue","Pink","Green"]}', tags: '["kids","tablet","educational"]', sku: 'KET-011' },
        { id: 'YMP-012', name: 'Yoga Mat Premium', nameAr: 'سجادة يوغا فاخرة', description: 'Extra thick non-slip yoga mat with alignment lines.', descriptionAr: 'سجادة يوغا سميكة غير قابلة للانزلاق مع خطوط محاذاة', price: 39.99, originalPrice: 59.99, images: '["https://placehold.co/400x400/10b981/ffffff?text=Bag"]', categoryId: categories[4].id, storeId: stores[4].id, stock: 300, rating: 4.5, reviewCount: 267, soldCount: 1560, isSale: true, variations: '{"color":["Purple","Teal","Black"]}', tieredPricing: '[{"minQty":10,"price":34.99},{"minQty":50,"price":29.99}]', tags: '["yoga","fitness"]', sku: 'YMP-012' },
        { id: 'OUD-013', name: 'Royal Oud Perfume', nameAr: 'عطر العود الملكي', description: 'Exquisite Arabian oud perfume with notes of sandalwood, amber, and rose. Long-lasting luxury fragrance.', descriptionAr: 'عطر عود عربي رائع بنوتات خشب الصندل والعنبر والورد', price: 129.99, originalPrice: 179.99, images: '["https://placehold.co/400x400/10b981/ffffff?text=Skincare"]', categoryId: categories[3].id, storeId: stores[3].id, stock: 90, rating: 4.8, reviewCount: 423, soldCount: 2800, isFeatured: true, isNew: true, isSale: true, hasFreeShipping: true, variations: '{"size":["30ml","50ml","100ml"]}', tags: '["oud","perfume","arabian"]', sku: 'OUD-013' },
        { id: 'ABB-014', name: 'Arabic Calligraphy Art Set', nameAr: 'طقم خط عربي', description: 'Professional Arabic calligraphy set with bamboo pens, ink, and practice paper. Includes instructional booklet.', descriptionAr: 'طقم خط عربي احترافي مع أقلام الخيزران والحبر وورق التمرين', price: 34.99, originalPrice: 49.99, images: '["https://placehold.co/400x400/10b981/ffffff?text=Skincare"]', categoryId: categories[7].id, storeId: stores[2].id, stock: 45, rating: 4.6, reviewCount: 87, soldCount: 320, isSale: true, variations: '{}', tags: '["calligraphy","arabic","art"]', sku: 'ABB-014' },
        { id: 'DTE-015', name: 'Emirati Dates Gift Box', nameAr: 'صندوق تمرات إماراتي هدية', description: 'Premium Emirati dates stuffed with almonds and coated with chocolate. Luxury gift packaging.', descriptionAr: 'تمر إماراتي فاخر محشي باللوز ومغلف بالشوكولاتة. تغليف هدايا فاخر', price: 54.99, originalPrice: 74.99, images: '["https://placehold.co/400x400/10b981/ffffff?text=Earbuds"]', categoryId: categories[8].id, storeId: stores[2].id, stock: 200, rating: 4.9, reviewCount: 198, soldCount: 1450, isFeatured: true, isSale: true, hasFreeShipping: true, variations: '{"size":["500g","1kg"]}', tags: '["dates","gift","emirati"]', sku: 'DTE-015' },
      ],
    });
    ...
    await db.app.createMany({
      data: [
        { name: 'NexaShop Manager', nameAr: 'مدير نكسا شوب', description: 'Manage your store, orders, and inventory on the go.', descriptionAr: 'أدر متجرك وطلباتك ومخزونك أثناء التنقل.', icon: 'https://placehold.co/200x200/10b981/ffffff?text=NexaShop', category: 'Business', developer: 'NexaMart Inc.', rating: 4.5, installs: 25000, price: 0, isFree: true },
        { name: 'Price Tracker Pro', nameAr: 'متتبع الأسعار برو', description: 'Track prices across multiple stores and get alerts when prices drop.', descriptionAr: 'تتبع الأسعار عبر متاجر متعددة واحصل على تنبيهات عند انخفاض الأسعار.', icon: 'https://placehold.co/200x200/10b981/ffffff?text=Price+Tracker', category: 'Shopping', developer: 'DealFinder Labs', rating: 4.3, installs: 18000, price: 0, isFree: true },
        { name: 'Inventory AI', nameAr: 'ذكاء المخزون', description: 'AI-powered inventory management with demand forecasting.', descriptionAr: 'إدارة المخزون بالذكاء الاصطناعي مع التنبؤ بالطلب.', icon: 'https://placehold.co/200x200/10b981/ffffff?text=Inventory+AI', category: 'Business', developer: 'SmartCommerce', rating: 4.7, installs: 8500, price: 9.99, isFree: false },
        { name: 'Review Analyzer', nameAr: 'محلل التقييمات', description: 'Analyze customer reviews with AI to improve your products.', descriptionAr: 'حلل تقييمات العملاء بالذكاء الاصطناعي لتحسين منتجاتك.', icon: 'https://placehold.co/200x200/10b981/ffffff?text=Review+Analyzer', category: 'Analytics', developer: 'InsightAI', rating: 4.1, installs: 5200, price: 4.99, isFree: false },
        { name: 'Social Seller Hub', nameAr: 'مركز البائع الاجتماعي', description: 'Connect your store to social media and manage sales channels.', descriptionAr: 'اربط متجرك بوسائل التواصل الاجتماعي وأدر قنوات البيع.', icon: 'https://placehold.co/200x200/10b981/ffffff?text=Social+Seller', category: 'Marketing', developer: 'SocialMart', rating: 4.4, installs: 12000, price: 0, isFree: true },
        { name: 'Shipping Optimizer', nameAr: 'محسن الشحن', description: 'Find the best shipping rates and routes for your deliveries.', descriptionAr: 'ابحث عن أفضل أسعار الشحن والمسارات لتوصيلاتك.', icon: 'https://placehold.co/200x200/10b981/ffffff?text=Shipping+Opt', category: 'Logistics', developer: 'LogiTech Solutions', rating: 4.0, installs: 6700, price: 0, isFree: true },
        { name: 'Halal Commerce Suite', nameAr: 'حزمة التجارة الحلال', description: 'Islamic commerce compliance tools. Verify halal certification and manage Sharia-compliant transactions.', descriptionAr: 'أدوات الامتثال التجاري الإسلامي. تحقق من شهادات الحلال وأدر المعاملات المتوافقة مع الشريعة.', icon: 'https://placehold.co/200x200/10b981/ffffff?text=Halal+Suite', category: 'Business', developer: 'HalalTech', rating: 4.8, installs: 15000, price: 14.99, isFree: false },
      ],
    });
    ...
    await db.car.createMany({
      data: [
        { title: 'Toyota Camry 2023 - Excellent Condition', titleAr: 'تويوتا كامري 2023 - حالة ممتازة', description: 'Well-maintained Toyota Camry 2023 with full service history. One owner, no accidents.', descriptionAr: 'تويوتا كامري 2023 صيانة كاملة، مالك واحد، بدون حوادث.', price: 24500, year: 2023, make: 'Toyota', model: 'Camry', trim: 'XSE', mileage: 18000, fuelType: 'gasoline', transmission: 'automatic', bodyType: 'sedan', condition: 'used', color: 'Pearl White', images: '["https://placehold.co/600x400/059669/ffffff?text=Toyota+Camry"]', city: 'Dubai', country: 'UAE', sellerId: seller.id, storeId: stores[0].id, status: 'active', isFeatured: true, views: 342 },
        { title: 'BMW X5 2022 - Luxury SUV', titleAr: 'بي إم دبليو X5 2022 - SUV فاخر', description: 'Premium BMW X5 with M Sport package. Panoramic roof, heads-up display, and Harman Kardon sound system.', descriptionAr: 'بي إم دبليو X5 باقة M الرياضية. سقف بانورامي ونظام صوت Harman Kardon.', price: 52000, year: 2022, make: 'BMW', model: 'X5', trim: 'M Sport', mileage: 32000, fuelType: 'gasoline', transmission: 'automatic', bodyType: 'suv', condition: 'used', color: 'Carbon Black', images: '["https://placehold.co/600x400/059669/ffffff?text=BMW+X5"]', city: 'Riyadh', country: 'Saudi Arabia', sellerId: seller.id, storeId: stores[0].id, status: 'active', isFeatured: true, views: 567 },
        { title: 'Mercedes C-Class 2024 - Brand New', titleAr: 'مرسيدس سي كلاس 2024 - جديدة', description: 'Brand new Mercedes C300 with AMG Line. Advanced driver assistance and MBUX infotainment.', descriptionAr: 'مرسيدس C300 جديدة بخط AMG. مساعد سائق متقدم ونظام ترفيه MBUX.', price: 48000, year: 2024, make: 'Mercedes-Benz', model: 'C-Class', trim: 'C300 AMG Line', mileage: 500, fuelType: 'gasoline', transmission: 'automatic', bodyType: 'sedan', condition: 'new', color: 'Obsidian Black', images: '["https://placehold.co/600x400/059669/ffffff?text=Mercedes+C-Class"]', city: 'Amman', country: 'Jordan', sellerId: seller2.id, storeId: stores[1].id, status: 'active', isFeatured: true, views: 789 },
        { title: 'Honda Civic 2021 - Reliable Daily Driver', titleAr: 'هوندا سيفيك 2021 - سيارة يومية موثوقة', description: 'Reliable Honda Civic with sporty looks. Great fuel economy, Honda Sensing safety suite.', descriptionAr: 'هوندا سيفيك موثوقة بمظهر رياضي. اقتصاد وقود ممتاز.', price: 16500, year: 2021, make: 'Honda', model: 'Civic', trim: 'Sport', mileage: 45000, fuelType: 'gasoline', transmission: 'automatic', bodyType: 'sedan', condition: 'used', color: 'Rallye Red', images: '["https://placehold.co/600x400/059669/ffffff?text=Honda+Civic"]', city: 'Baghdad', country: 'Iraq', sellerId: seller.id, status: 'active', views: 234 },
        { title: 'Tesla Model 3 2023 - Electric', titleAr: 'تيسلا موديل 3 2023 - كهربائية', description: 'Tesla Model 3 Long Range with Autopilot. Supercharger network access and zero emissions.', descriptionAr: 'تيسلا موديل 3 طويلة المدى مع القيادة الذاتية. وصول لشبكة Supercharger.', price: 38500, year: 2023, make: 'Tesla', model: 'Model 3', trim: 'Long Range', mileage: 12000, fuelType: 'electric', transmission: 'automatic', bodyType: 'sedan', condition: 'used', color: 'Midnight Silver', images: '["https://placehold.co/600x400/059669/ffffff?text=Tesla+Model+3"]', city: 'Dubai', country: 'UAE', sellerId: seller2.id, storeId: stores[1].id, status: 'active', isFeatured: true, views: 923 },
        { title: 'Nissan Patrol 2023 - Desert Ready', titleAr: 'نيسان باترول 2023 - جاهز للصحراء', description: 'Nissan Patrol V8 with off-road package. Full service history, never been in sand dunes. GCC specs.', descriptionAr: 'نيسان باترول V8 مع حزمة الطرق الوعرة. تاريخ صيانة كامل، مواصفات الخليج.', price: 42000, year: 2023, make: 'Nissan', model: 'Patrol', trim: 'LE V8', mileage: 25000, fuelType: 'gasoline', transmission: 'automatic', bodyType: 'suv', condition: 'used', color: 'Sand Beige', images: '["https://placehold.co/600x400/059669/ffffff?text=Nissan+Patrol"]', city: 'Kuwait City', country: 'Kuwait', sellerId: seller3.id, storeId: stores[2].id, status: 'active', isFeatured: true, views: 678 },
        { title: 'Toyota Land Cruiser 2022', titleAr: 'تويوتا لاند كروزر 2022', description: 'Iconic Land Cruiser with full options. White exterior, beige leather interior. One owner, GCC specs.', descriptionAr: 'لاند كروزر الأيقوني بكل الخيارات. خارجي أبيض وداخلي جلد بيج. مالك واحد.', price: 55000, year: 2022, make: 'Toyota', model: 'Land Cruiser', trim: 'VXR', mileage: 28000, fuelType: 'diesel', transmission: 'automatic', bodyType: 'suv', condition: 'used', color: 'Super White', images: '["https://placehold.co/600x400/059669/ffffff?text=Land+Cruiser"]', city: 'Muscat', country: 'Oman', sellerId: seller5.id, status: 'active', isFeatured: true, views: 1100 },
      ],
    });
    ...
    await db.property.createMany({
      data: [
        { title: 'Luxury 2BR Apartment in Dubai Marina', titleAr: 'شقة فاخرة غرفتين في دبي مارينا', description: 'Stunning 2-bedroom apartment with full sea view in Dubai Marina. High floor, modern finishes.', descriptionAr: 'شقة غرفتين مذهلة بإطلالة بحرية كاملة في دبي مارينا.', price: 185000, listingType: 'sale', propertyType: 'apartment', bedrooms: 2, bathrooms: 2, area: 120, isFurnished: true, city: 'Dubai', country: 'UAE', address: 'Dubai Marina Walk, Tower A, Floor 35', images: '["https://placehold.co/600x400/0d9488/ffffff?text=Dubai+Marina"]', agentName: 'Mohammed Al-Fahim', agentPhone: '+971501234567', isVerifiedAgent: true, sellerId: seller.id, storeId: stores[0].id, status: 'active', isFeatured: true, views: 1245 },
        { title: 'Modern 3BR Villa in Riyadh', titleAr: 'فيلا حديثة 3 غرف في الرياض', description: 'Spacious 3-bedroom villa in Al Nakheel district with private garden and maid room.', descriptionAr: 'فيلا واسعة 3 غرف في حي النخيل مع حديقة خاصة وغرفة خادمة.', price: 950000, listingType: 'sale', propertyType: 'villa', bedrooms: 3, bathrooms: 3, area: 350, isFurnished: false, city: 'Riyadh', country: 'Saudi Arabia', address: 'Al Nakheel District, Street 15', images: '["https://placehold.co/600x400/0d9488/ffffff?text=Riyadh+Villa"]', agentName: 'Abdullah Al-Salem', agentPhone: '+966509876543', isVerifiedAgent: true, sellerId: seller2.id, storeId: stores[1].id, status: 'active', isFeatured: true, views: 876 },
        { title: 'Cozy Studio for Rent in Amman', titleAr: 'استوديو مريح للإيجار في عمّان', description: 'Modern studio apartment in Abdoun area. Fully furnished with kitchen appliances and AC.', descriptionAr: 'استوديو حديث في منطقة عبدون. مفروش بالكامل مع أجهزة مطبخ وتكييف.', price: 650, listingType: 'rent', propertyType: 'apartment', bedrooms: 1, bathrooms: 1, area: 55, isFurnished: true, city: 'Amman', country: 'Jordan', address: 'Abdoun, Building 23, Floor 4', images: '["https://placehold.co/600x400/0d9488/ffffff?text=Amman+Studio"]', agentName: 'Lina Haddad', agentPhone: '+962795551234', isVerifiedAgent: false, sellerId: seller3.id, storeId: stores[2].id, status: 'active', views: 432 },
        { title: 'Commercial Office Space in Baghdad', titleAr: 'مكتب تجاري في بغداد', description: 'Prime commercial office space in Karrada district. 200 sqm, fully equipped with internet and parking.', descriptionAr: 'مكتب تجاري مميز في الكرادة. 200 متر مربع، مجهز بالكامل.', price: 2500, listingType: 'rent', propertyType: 'commercial', bedrooms: null, bathrooms: 2, area: 200, isFurnished: true, city: 'Baghdad', country: 'Iraq', address: 'Karrada Main Street, Tower 7, Floor 8', images: '["https://placehold.co/600x400/0d9488/ffffff?text=Baghdad+Office"]', agentName: 'Ali Al-Jabri', agentPhone: '+9647701122334', isVerifiedAgent: true, sellerId: seller.id, storeId: stores[0].id, status: 'active', views: 198 },
        { title: 'Luxury Penthouse in Doha', titleAr: 'بنتهاوس فاخر في الدوحة', description: 'Exclusive penthouse with panoramic views of West Bay. 4 bedrooms, private terrace, and concierge service.', descriptionAr: 'بنتهاوس حصري بإطلالات بانورامية على الخليج الغربي. 4 غرف وتراس خاص.', price: 3200000, listingType: 'sale', propertyType: 'apartment', bedrooms: 4, bathrooms: 4, area: 380, isFurnished: true, city: 'Doha', country: 'Qatar', address: 'West Bay, The Pearl, Tower 12', images: '["https://placehold.co/600x400/0d9488/ffffff?text=Doha+Penthouse"]', agentName: 'Khalid Al-Thani', agentPhone: '+97455551234', isVerifiedAgent: true, sellerId: seller.id, storeId: stores[0].id, status: 'active', isFeatured: true, views: 2310 },
        { title: 'Furnished Apartment in Cairo', titleAr: 'شقة مفروشة في القاهرة', description: 'Beautiful 2-bedroom furnished apartment in Zamalek. Nile view, balcony, and modern amenities.', descriptionAr: 'شقة مفروشة جميلة غرفتين في الزمالك. إطلالة على النيل وشرفة.', price: 1200, listingType: 'rent', propertyType: 'apartment', bedrooms: 2, bathrooms: 2, area: 140, isFurnished: true, city: 'Cairo', country: 'Egypt', address: 'Zamalek, 26 July Street', images: '["https://placehold.co/600x400/0d9488/ffffff?text=Cairo+Apt"]', agentName: 'Hassan Mahmoud', agentPhone: '+201001234567', isVerifiedAgent: true, sellerId: seller4.id, storeId: stores[3].id, status: 'active', isFeatured: false, views: 345 },
      ],
    });
    ...
    await db.classified.createMany({
      data: [
        { title: 'IKEA Sofa Set - Like New', titleAr: 'طقم أريكة إيكيا - كالجديدة', description: '3-piece IKEA sofa set in beige fabric. Less than 6 months old, moving sale.', descriptionAr: 'طقم أريكة إيكيا 3 قطع بقماش بيج. عمرها أقل من 6 أشهر، بيع بسبب الانتقال.', price: 450, categoryId: categories[2].id, condition: 'used', city: 'Dubai', country: 'UAE', images: '["https://placehold.co/600x400/14b8a6/ffffff?text=Sofa+Set"]', contactPhone: '+971501234567', sellerId: user.id, status: 'active', isFeatured: true, views: 156, expiresAt: new Date(now.getTime() + 30 * 24 * 60 * 60 * 1000) },
        { title: 'Samsung 65" Smart TV', titleAr: 'تلفزيون سامسونج 65 بوصة ذكي', description: 'Samsung QLED 65-inch Smart TV, 4K resolution. Comes with wall mount.', descriptionAr: 'تلفزيون سامسونج QLED 65 بوصة ذكي، دقة 4K. يأتي مع حائط.', price: 380, categoryId: categories[0].id, condition: 'used', city: 'Riyadh', country: 'Saudi Arabia', images: '["https://placehold.co/600x400/14b8a6/ffffff?text=Samsung+TV"]', contactPhone: '+966509876543', sellerId: buyer2.id, status: 'active', views: 89, expiresAt: new Date(now.getTime() + 21 * 24 * 60 * 60 * 1000) },
        { title: 'iPhone 14 Pro Max 256GB', titleAr: 'آيفون 14 برو ماكس 256 جيجا', description: 'Unlocked iPhone 14 Pro Max in Deep Purple. Battery health 94%.', descriptionAr: 'آيفون 14 برو ماكس مفتوح بلون بنفسجي غامق. صحة البطارية 94%.', price: 750, categoryId: categories[0].id, condition: 'used', city: 'Amman', country: 'Jordan', images: '["https://placehold.co/600x400/14b8a6/ffffff?text=iPhone+14"]', contactPhone: '+962795551234', sellerId: user.id, status: 'active', isFeatured: true, views: 312, expiresAt: new Date(now.getTime() + 14 * 24 * 60 * 60 * 1000) },
        { title: 'Office Desk with Chair', titleAr: 'مكتب عمل مع كرسي', description: 'Large L-shaped office desk with ergonomic chair. Perfect for home office.', descriptionAr: 'مكتب عمل كبير بشكل L مع كرسي مريح. مثالي لمكتب منزلي.', price: 220, categoryId: categories[2].id, condition: 'new', city: 'Baghdad', country: 'Iraq', images: '["https://placehold.co/600x400/14b8a6/ffffff?text=Office+Desk"]', contactPhone: '+9647701122334', sellerId: seller3.id, status: 'active', views: 67, expiresAt: new Date(now.getTime() + 30 * 24 * 60 * 60 * 1000) },
        { title: 'PlayStation 5 with 3 Games', titleAr: 'بلايستيشن 5 مع 3 ألعاب', description: 'PS5 Disc Edition with Spider-Man 2, God of War Ragnarok, and FIFA 24.', descriptionAr: 'بلايستيشن 5 نسخة القرص مع Spider-Man 2 وGod of War Ragnarok وFIFA 24.', price: 520, categoryId: categories[5].id, condition: 'used', city: 'Dubai', country: 'UAE', images: '["https://placehold.co/600x400/14b8a6/ffffff?text=PS5"]', contactPhone: '+971509876543', sellerId: buyer2.id, status: 'active', isFeatured: true, views: 245, expiresAt: new Date(now.getTime() + 7 * 24 * 60 * 60 * 1000) },
        { title: 'Arabic Darbuka Drum', titleAr: 'طبلة دربكة عربية', description: 'Handcrafted Egyptian darbuka with mother-of-pearl inlay. Professional quality sound.', descriptionAr: 'دربكة مصرية مصنوعة يدوياً بترصيع من أم اللؤلؤ. جودة صوت احترافية.', price: 85, categoryId: categories[7].id, condition: 'new', city: 'Cairo', country: 'Egypt', images: '["https://placehold.co/600x400/14b8a6/ffffff?text=Darbuka"]', contactPhone: '+201009998877', sellerId: buyer3.id, status: 'active', views: 54, expiresAt: new Date(now.getTime() + 60 * 24 * 60 * 60 * 1000) },
      ],
    });
    ...
    await db.job.createMany({
      data: [
        { title: 'Senior Software Engineer', titleAr: 'مهندس برمجيات أول', description: 'We are looking for a Senior Software Engineer to join our growing team. You will work on building scalable microservices.', descriptionAr: 'نبحث عن مهندس برمجيات أول للانضمام لفريقنا.', company: 'NexaTech Solutions', companyLogo: 'https://placehold.co/200x200/6366f1/ffffff?text=NexaTech', location: 'Dubai Internet City', city: 'Dubai', country: 'UAE', type: 'full-time', salaryMin: 8000, salaryMax: 14000, currency: 'AED', experienceLevel: 'senior', skills: '["Node.js","TypeScript","AWS","Docker","PostgreSQL"]', category: 'Engineering', contactEmail: 'careers@nexatech.ae', posterId: seller.id, status: 'active', isFeatured: true, views: 567 },
        { title: 'Marketing Manager', titleAr: 'مدير تسويق', description: 'Seeking an experienced Marketing Manager to lead our digital marketing efforts across the MENA region.', descriptionAr: 'نبحث عن مدير تسويق ذو خبرة لقيادة جهود التسويق الرقمي في منطقة الشرق الأوسط.', company: 'Gulf Brands Group', companyLogo: 'https://placehold.co/200x200/6366f1/ffffff?text=Gulf+Brands', location: 'King Fahd Road', city: 'Riyadh', country: 'Saudi Arabia', type: 'full-time', salaryMin: 12000, salaryMax: 18000, currency: 'SAR', experienceLevel: 'mid', skills: '["Digital Marketing","SEO","Social Media","Content Strategy"]', category: 'Marketing', contactEmail: 'hr@gulfbrands.sa', posterId: seller2.id, status: 'active', isFeatured: true, views: 423 },
        { title: 'Accountant', titleAr: 'محاسب', description: 'Join our finance team as an Accountant. Responsibilities include preparing financial statements.', descriptionAr: 'انضم لفريقنا المالي كمحاسب. تشمل المسؤوليات إعداد البيانات المالية.', company: 'Al-Rashid Trading Co.', companyLogo: 'https://placehold.co/200x200/6366f1/ffffff?text=Al+Rashid', location: 'Sharq District', city: 'Kuwait City', country: 'Kuwait', type: 'full-time', salaryMin: 2000, salaryMax: 3500, currency: 'KWD', experienceLevel: 'mid', skills: '["Accounting","Excel","IFRS","SAP"]', category: 'Finance', contactEmail: 'jobs@alrashid.kw', posterId: seller3.id, status: 'active', views: 234 },
        { title: 'UX/UI Designer - Remote', titleAr: 'مصمم UX/UI - عن بعد', description: 'Looking for a talented UX/UI Designer to create beautiful and intuitive interfaces.', descriptionAr: 'نبحث عن مصمم UX/UI موهوب لإنشاء واجهات جميلة وبديهية.', company: 'CreativePixel Agency', companyLogo: 'https://placehold.co/200x200/6366f1/ffffff?text=CreativePixel', location: 'Remote', city: 'Amman', country: 'Jordan', type: 'remote', salaryMin: 1500, salaryMax: 3000, currency: 'JOD', experienceLevel: 'mid', skills: '["Figma","Adobe XD","User Research","Prototyping"]', category: 'Design', contactEmail: 'design@creativepixel.jo', posterId: seller4.id, status: 'active', isFeatured: true, views: 389 },
        { title: 'Sales Associate - Part Time', titleAr: 'مندوب مبيعات - دوام جزئي', description: 'Part-time Sales Associate position at our electronics store.', descriptionAr: 'وظيفة مندوب مبيعات بدوام جزئي في متجر الإلكترونيات.', company: 'TechZone Retail', companyLogo: 'https://placehold.co/200x200/6366f1/ffffff?text=TechZone', location: 'Mansour District', city: 'Baghdad', country: 'Iraq', type: 'part-time', salaryMin: 500, salaryMax: 800, currency: 'USD', experienceLevel: 'entry', skills: '["Sales","Customer Service","Communication"]', category: 'Sales', contactEmail: 'hr@techzone.iq', posterId: seller5.id, status: 'active', views: 156 },
        { title: 'Arabic Content Writer - Freelance', titleAr: 'كاتب محتوى عربي - حر', description: 'Freelance Arabic content writer needed for e-commerce product descriptions and blog articles.', descriptionAr: 'مطلوب كاتب محتوى عربي حر لكتابة وصف المنتجات والمقالات.', company: 'NexaMart Content', companyLogo: 'https://placehold.co/200x200/6366f1/ffffff?text=NexaMart', location: 'Remote', city: 'Cairo', country: 'Egypt', type: 'freelance', salaryMin: 15, salaryMax: 30, currency: 'USD', experienceLevel: 'mid', skills: '["Arabic Writing","SEO","Content Strategy","E-commerce"]', category: 'Content', contactEmail: 'content@nexamart.com', posterId: admin.id, status: 'active', isFeatured: true, views: 678 },
      ],
    });
    ...
    await db.banner.createMany({
      data: [
        { title: 'Mega Electronics Sale', titleAr: 'تخفيضات الإلكترونيات الكبرى', image: 'https://placehold.co/1200x400/059669/ffffff?text=Electronics+Sale', link: '/deals?category=electronics', position: 'home_top', isActive: true, startDate: new Date(now.getTime() - 1 * 24 * 60 * 60 * 1000), endDate: new Date(now.getTime() + 7 * 24 * 60 * 60 * 1000) },
        { title: 'Ramadan Collection', titleAr: 'مجموعة رمضان', image: 'https://placehold.co/1200x400/059669/ffffff?text=Ramadan+Collection', link: '/products?tag=ramadan', position: 'home_mid', isActive: true, startDate: new Date(now.getTime() - 5 * 24 * 60 * 60 * 1000), endDate: new Date(now.getTime() + 25 * 24 * 60 * 60 * 1000) },
        { title: 'New Arrivals in Fashion', titleAr: 'وصولات جديدة في الأزياء', image: 'https://placehold.co/1200x400/059669/ffffff?text=New+Fashion', link: '/products?category=fashion&sort=newest', position: 'home_top', isActive: true, startDate: new Date(now.getTime() - 3 * 24 * 60 * 60 * 1000), endDate: new Date(now.getTime() + 14 * 24 * 60 * 60 * 1000) },
        { title: 'Eid Al-Fitr Special', titleAr: 'عرض عيد الفطر الخاص', image: 'https://placehold.co/1200x400/059669/ffffff?text=Eid+Special', link: '/deals?tag=eid', position: 'home_mid', isActive: true, startDate: new Date(now.getTime() - 2 * 24 * 60 * 60 * 1000), endDate: new Date(now.getTime() + 10 * 24 * 60 * 60 * 1000) },
        { title: 'Arabian Oud Collection', titleAr: 'مجموعة العود العربية', image: 'https://placehold.co/1200x400/059669/ffffff?text=Oud+Collection', link: '/products?tag=oud', position: 'product_page', isActive: true, startDate: new Date(now.getTime() - 1 * 24 * 60 * 60 * 1000), endDate: new Date(now.getTime() + 30 * 24 * 60 * 60 * 1000) },
      ],
    });
