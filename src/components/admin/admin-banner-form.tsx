...
import type { BannerData, BannerFormData } from "@/components/admin/admin-banner-constants";
...
export function AdminBannerForm({
  ...
  const update = (partial: Partial<BannerFormData>) => onFormChange({ ...form, ...partial });
