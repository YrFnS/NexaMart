...
import { GRADIENT_PRESETS, ICON_MAP } from "@/components/admin/admin-banner-constants";
...
export function BannerPreviewCard({ banner }: { banner: BannerData }) {
  ...
  return (
    ...
    >
      <BannerIcon iconKey={banner.icon} className="h-16 w-16 absolute top-4 right-4 opacity-30" />
